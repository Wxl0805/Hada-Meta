	...
	<view class="uni-easyinput" :class="{'uni-easyinput-error':msg}" :style="boxStyle">
		<view class="uni-easyinput__content" :class="inputContentClass" :style="inputContentStyle">
			...
			<textarea v-if="type === 'textarea'" class="uni-easyinput__content-textarea"
				...
				:placeholderStyle="placeholderStyle" :disabled="disabled" :adjust-position="false"
			...
			<input v-else :type="type === 'password'?'text':type" class="uni-easyinput__content-input"
				...
				:placeholder="placeholder" :placeholderStyle="placeholderStyle" :adjust-position="false"
				...
				@confirm="onConfirm" auto-blur="true"/>
			<template v-if="type === 'password' && passwordIcon">
				...
				<uni-icons v-if="isVal" class="content-clear-icon" :class="{'is-textarea-icon':type==='textarea'}"
					...
					:color="focusShow?'#c0c4cc':'#c0c4cc'" @click="onEyes">
				</uni-icons>
			</template>
			...
			<template v-else>
				<uni-icons v-if="clearable && isVal && !disabled  && type !== 'textarea'" class="content-clear-icon"
					...
					:color="msg?'#dd524d':(focusShow?'#c0c4cc':'#c0c4cc')" @click="onClear"></uni-icons>
			</template>
...
<style lang="scss">
	...
	.uniui-clear[data-v-a2e81f6e]:before{
		content: "\e66c";
		font-size: 44rpx;
		// background: url('@/static/images/login/delete.png');

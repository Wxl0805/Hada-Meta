	...
	<view class="content">
		...
		<!-- <view class="mod2 flex-col justify-end" v-if="select">
		  <view class="group1 flex-row justify-between">
		    <text class="info2">{{$t('mine-editpassword-email-vali')}}</text>
		...
		<!-- <view class="outer3 flex-col justify-end"v-else>
		  <view class="outer4 flex-row justify-between">
		    <text class="xiugai-4">{{$t('mine-editpassword-email-vali')}}</text>
		...
		<view class="wrap2 flex-col" v-if="select">
		  <!-- <view class="InputNumber1 flex-col">
		    <uni-easyinput :inputBorder="false" :disabled="true" v-model="email" placeholder="请输入邮箱"></uni-easyinput>
		  </view>
		  <view class="block1 flex-col">
		    <view class="vali-block">
		    	<view class="telvalicode">
		    		<uni-easyinput :inputBorder="false" v-model="valicode" :placeholder="$t('mine.change-emailvericode')"></uni-easyinput>
		    	</view>
		    	<image
		    	  class="icon1"
		...
		<!-- 设置新密码 -->
		 <view class="bd10 flex-col" v-else>
		  <!-- <view class="InputNumber1 flex-col">
		      <uni-easyinput type="password" :inputBorder="false" v-model="newpassword" :placeholder="$t('mine-editpassword-newpassword-input')"></uni-easyinput>
		  </view>
		  <view class="mod1 flex-col">
			  <uni-easyinput type="password" :inputBorder="false" v-model="confirmpassword" :placeholder="$t('mine-editpassword-confirm-input')"></uni-easyinput>
		  </view> -->
		  <view class="input">
		...
		methods: {
			select1() {
				...
				uni.request({
					...
					url: this.host+'/app/checkemailcode?type=resetpwdbyemail&value='+this.email+'&code='+this.valicode,
					method: 'GET',
					data: {},
					dataType:'json',
					success: (res) => {
			...
			select2(){
				...
				uni.request({
					...
					url: this.host+'/app/resetpwdbyemail?email='+this.email+'&code='+this.valicode+'&newpassword='+this.newpassword,
					method: 'GET',
					data: {},
					dataType:'json',
					success: (res) => {
			...
			sendvalidate(){
				...
				uni.request({
					...
					url: this.host+'/app/getemailcode?type=resetpwdbyemail&value='+this.email,
					method: 'GET',
					data: {},
					dataType:'json',
					success: (res) => {

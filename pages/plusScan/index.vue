...
export default {
  ...
  methods: {
    ...
    onmarked(type, result) {
      ...
      // 跳转到扫码成功页面
      uni.navigateTo({
        url: "/pages/equipment/inputBindInfo?resultCode=" + result,
        success(res) {
        },
        fail(res) {
        },
    ...
    createView(currentWebview) {
      ...
      // 创建打开相册的按钮
      const photoAlbumView = new plus.nativeObj.View(
        "photoAlbumView",
        {
          top: "80%",
          left: "64%",
      ...
      // 创建扫码下方的文字组件
      const text = new plus.nativeObj.View(
        "text",
        {
          top: "64%",
          left: "0px",
                ...
                success: function (image) {
                  plus.barcode.scan(
                    ...
                    function (type, result) {
                      ...
                      uni.navigateTo({
                        url:
                          "/pages/equipment/inputBindInfo?resultCode=" + result,
                        success(res) {
                        },
                        fail(res) {
                        },
